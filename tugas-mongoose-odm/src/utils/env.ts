...
export const DATABASE_URL: string = "mongodb+srv://LooSry:VJX99SIIsuviFwXl@cluster-wpu-course.bdnqo.mongodb.net/?retryWrites=true&w=majority&appName=cluster-wpu-course";
